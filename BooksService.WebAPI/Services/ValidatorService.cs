...
namespace BooksService.WebAPI.Services
{
  ...
  public class ValidatorService : IValidatorService
  {
    ...
    public  List<string> ValidateBook(Book book)
    {
      ...
      {
        errors.Add("Title is invalid: Title must contain a minimum of 5 characters and a maximum of 255, and the first letter should be in upper case");
      }
      ...
      {
        errors.Add("PublicationDate is invalid: PublicationDate must be after 01/01/1900 and before the current date");
      }
      return errors;
    }
  }
